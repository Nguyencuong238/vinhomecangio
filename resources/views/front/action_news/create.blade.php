        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="profile-info-block">
                    <form action="{{ route('action-news.store') }}" method="post" id="create_form">
                        @csrf
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <h5 class="card-title">{{ __('Thêm bài viết') }}</h5>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="excerpt" class="form-control @error('excerpt')is-invalid @enderror" placeholder="Add excerpt" rows="6">{{ old('excerpt') }}</textarea>
                                    @error('excerpt')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
