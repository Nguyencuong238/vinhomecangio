    ...
    <form action="{{ route('blogs.store') }}" method="post">
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-title">{{ __('Thêm blog bài viết') }}</h5>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                @include('backend.blogs._meta', ['model' => new \App\Models\Blog])
            </div>
            <div class="col-md-3">
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="collapse show" id="category">
                        <div class="card-body">
                            @include('backend.blogs._categories', ['categories' => $categories, 'selected' => old('categories', [])])
                        </div>
                    </div>
                </div>
