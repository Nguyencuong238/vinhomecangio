                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>{{ __('Role') }}:</label>
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name')is-invalid @enderror" placeholder="Admin, ...">
                            @error('name')
                                                                    ...
                                                                    <div class="col-md-7 col-sm-8">
                                                                        <div class="form-group float-right mr-2">
                                                                            <div class="form-check form-check-inline">
                                                                                <input type="radio" id="a_p_{{ $permission->id }}" class="form-check-input permission-allow" {{ old('permissions') && old('permissions')[$permission->name] == 1 ? 'checked' : null }} name="permissions[{{ $permission->name }}]" value="1">
