...
@push('css')
    ...
    <style>
        ...
        .big-video-img, .jeg_pl_lg_box .jeg_postblock_content {
            border-radius: 3px;
        }
        .big-video-img {
            max-height: 640px;
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            @foreach($videos as $video)
                                @if($loop->index == 0)
                                <div class="jeg_pl_lg_box col-lg-12">
                                    <div class="box_wrap">
                                        <a href="{{ $video->showUrl() }}">
                                            <img src="{{ $video->getFirstMediaUrl('media') }}" class="w-100 big-video-img" alt="{{ $video->title }}">
                                        </a>
                                ...
                                <div class="col-lg-4 col-sm-6 mb-4">
                                    <div class="jeg_thumb">
                                        <a href="{{ $video->showUrl() }}">
                                            <img src="{{ $video->getFirstMediaUrl('media') }}" class="w-100 video-img" alt="{{ $video->title }}">
                                        </a>
                                    </div>
                                    <div class="jeg_postblock_content">
                                        <h3 class="jeg_post_title mt-2 mb-0 p-0">
                                            <a href="{{ $video->showUrl() }}" class="text-2-line">{{ $video->title }}</a>
                                        </h3>
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="jeg_block_navigation mt-3">
                            {{ $videos->links() }}
                        </div>
                    </div>
                </div>
