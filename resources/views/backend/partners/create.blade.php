                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="twitter_url" value="{{ old('twitter_url') }}" class="form-control @error('twitter_url')is-invalid @enderror">
                            @error('twitter_url')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="facebook_url" value="{{ old('facebook_url') }}" class="form-control @error('facebook_url')is-invalid @enderror">
                            @error('facebook_url')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="telegram_url" value="{{ old('telegram_url') }}" class="form-control @error('telegram_url')is-invalid @enderror">
                            @error('telegram_url')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="website_url" value="{{ old('website_url') }}" class="form-control @error('website_url')is-invalid @enderror">
                            @error('website_url')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
